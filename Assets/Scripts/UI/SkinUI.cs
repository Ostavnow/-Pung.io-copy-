...
namespace UI
{
    public class SkinUI : MonoBehaviour
    {
        ...
        [SerializeField] private Transform _listSkinsTransform;
        ...
        public void UpdateListPurchasedSkins()
        {
            ...
            {
                _listSkinsTransform.GetChild(_user._purchasedSkins[i] - 3).GetComponent<SkinCellUI>().SkinIsPurchased = true;
            }
        }
        public void BuySkin(int id)
        {
            if(_user.CoinBalance >= _skins._listSkins[id]._price)
            {
                ...
                _listSkinsTransform.GetChild(_user._purchasedSkins[id - 3]).GetComponent<SkinCellUI>().SkinIsPurchased = true;
            }
        ...
        public void ConfirmationSkinRefund()
        {
            ...
            _dataManager.SaveProgress();
            _listSkinsTransform.GetChild(_user._purchasedSkins[_idSelectedSkin - 3]).GetComponent<SkinCellUI>().SkinIsPurchased = false;
            _refundPanel.SetActive(false);
        }
    }
}